...
//const { handleAntiStickerCommand, AntiSticker } = require('./lib/antisticker');
const { AntiSticker, handleAntiStickerCommand } = require('./lib/antisticker'); 
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        if (isGroup) {
            ...
            //await AntiSticker(message, sock);
        }
        //sticker
    ...
    // rest of your handler...
       ...
       //sticker
        ...
        const adminCommands = ['.mute', '.unmute', '.ban', '.unban', '.promote', '.demote', '.kick', '.tagall', '.tagnotadmin', '.hidetag', '.antilink', '.antitag', '.setgdesc', '.setgname', '.antisticker', '.setgpp'];
